...
#'
#'
#' @details \code{L} is used to achieve good spatial balance. It must be larger than one.
#' The number of units that remain in the selected spread set will be the sum of all elements of \code{pik} multiplied by \code{L}.
#'
#'
